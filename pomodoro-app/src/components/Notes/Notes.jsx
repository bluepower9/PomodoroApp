...
export default function Notes(props){
    ...
    return (
        <div class="flex flex-col h-full w-full">
            <div class={`flex bg-gray-800 h-fit text-3xl px-3 pb-2 text-white hover:cursor-pointer ${expanded?"w-full rounded-t-xl": "w-fit rounded-xl"}`} onClick={()=>setexpanded(!expanded)}>
